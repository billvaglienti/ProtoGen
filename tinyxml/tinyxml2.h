...
private:
    ...
    static bool _StringEqual( const char* p, const char* q, int nChar );
};
...
public:
    ...
    //! Test the name of this element, case insensitive
    bool testName(const char* str) const;
