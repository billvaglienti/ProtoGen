...
This document refers to ProtoGen version 1.4.5. You can download the [windows version here](https://github.com/billvaglienti/ProtoGen/releases/download/1.4.5.b/ProtoGenWin.zip). The [mac version is here](https://github.com/billvaglienti/ProtoGen/releases/download/1.4.5.b/ProtoGenMac.zip). The [linux version is here](https://github.com/billvaglienti/ProtoGen/releases/download/1.4.5.b/ProtoGenLinux.tgz). Source code for ProtoGen is available on [github](https://github.com/billvaglienti/ProtoGen).
