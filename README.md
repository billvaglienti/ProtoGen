...
- `-yes-doxygen` will cause ProtoGen to output of developer level html documentation from doxygen. This step can add significant time and may not be appropriate when using ProtoGen as a build step.
